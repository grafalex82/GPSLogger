...
FIND_PATH(CMSIS_DEVICE_INCLUDE_DIR ${CMSIS_DEVICE_HEADERS}
    PATH_SUFFIXES include stm32${STM32_FAMILY_LOWER} cmsis
    HINTS ${STM32Cube_DIR}/Drivers/CMSIS/Device/ST/STM32${STM32_FAMILY}xx/Include ${STM32Cube_DIR}/STM32F1/CMSIS_Inc
    CMAKE_FIND_ROOT_PATH_BOTH
)
...
FOREACH(SRC ${CMSIS_DEVICE_SOURCES})
    ...
    FIND_FILE(CMSIS_${SRC_CLEAN}_FILE ${SRC}
        ...
        HINTS ${STM32Cube_DIR}/Drivers/CMSIS/Device/ST/STM32${STM32_FAMILY}xx/Source/Templates/ ${STM32Cube_DIR}/STM32F1/HAL_Src
        CMAKE_FIND_ROOT_PATH_BOTH
    )
...
IF(STM32_CHIP_TYPE)
    ...
    FIND_FILE(CMSIS_STARTUP_SOURCE_FILE ${CMSIS_STARTUP_SOURCE}
        PATH_SUFFIXES src stm32${STM32_FAMILY_LOWER} cmsis
        HINTS ${STM32Cube_DIR}/Drivers/CMSIS/Device/ST/STM32${STM32_FAMILY}xx/Source/Templates/gcc/ ${STM32Cube_DIR}/STM32F1/CMSIS_Src
        CMAKE_FIND_ROOT_PATH_BOTH
    )
