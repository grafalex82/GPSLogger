...
ELSEIF(STM32_FAMILY STREQUAL "F1")
    SET(LL_COMPONENTS	adc bus cortex crc dac dma exti gpio i2c
						i2s iwdg pwr rcc rtc spi system tim usart usb utils wwdg)
...
FIND_PATH(STM32LL_INCLUDE_DIR ${LL_HEADERS}
	...
	HINTS ${STM32Cube_DIR}/Drivers/STM32${STM32_FAMILY}xx_HAL_Driver/Inc ${STM32Cube_DIR}/STM32${STM32_FAMILY}/HAL_Inc
...
FOREACH(LL_SRC ${LL_SRCS})
	...
	FIND_FILE(LL_${LL_SRC_CLEAN}_FILE ${LL_SRC}
		...
		HINTS ${STM32Cube_DIR}/Drivers/STM32${STM32_FAMILY}xx_HAL_Driver/Src ${STM32Cube_DIR}/STM32${STM32_FAMILY}/HAL_Src
		CMAKE_FIND_ROOT_PATH_BOTH
	)
